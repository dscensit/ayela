            ...
            <div class="footer-top">
                <div class="row">
                    <div class="col-md-6 col-xl-3 mb-30">
                        <div class="mb-30">
                            <img class="logo-footer" src="assets/img/AYELA_Logo.png" alt="Bootbox">
                        </div>
                        <p class="mb-30 c-white">Service gratuit pour retrouver un document perdu. Que vous ayez perdu votre Attestation, votre CNI, votre PassePort, votre Assurance...</p>
                        <div class="socials">
                    ...
                    <div class="col-md-6 col-xl-3 mb-30">
                        ...
                        <div class="foot-links">
                            ...
                            <a href="https://dsc-ensit.web.app/">FAQ</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3 mb-30">
