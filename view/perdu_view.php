    ...
    <section class="cta-section position-relative">
        <div class="container">
            <div class="cta-box bg-white wow fadeInUp" data-wow-delay="0.2s">
                ...
                <p class="mb-30 mx-auto">Developer Student Clubs est un programme présenté par Google Developers. Les DSC sont des groupes communautaires universitaires pour les étudiants de tous les programmes souhaitant être développeurs. Développement web et mobile , Cloud et compétences en leadership.
                </p>
